import { View, Text, ScrollView, Image, ActivityIndicator, Animated, Pressable } from "react-native";
...
export default function UserProfileScreen() {
    ...
    const imageBase64 = profile?.Image?.data ? bufferToBase64(profile.Image.data) : null;
    const imageUri = imageBase64 ? `data:${profile.Image.contentType};base64,${imageBase64}` : null;
